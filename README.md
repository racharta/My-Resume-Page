...
<div class="w3-row">
  <div class="w3-half w3-black w3-container w3-center" style="height:700px">
    ...
    <div class="w3-padding-64">
      ...
      <a href="#work" class="w3-button w3-black w3-block w3-hover-teal w3-padding-16">My Achievements</a>
  ...
  <div class="w3-half w3-blue-grey w3-container" style="height:700px">
    <div class="w3-padding-64 w3-center">
      <h1>About Me</h1>
      <img src="/Assets/foto Rachma.JPEG" class="w3-margin w3-circle" alt="Person" style="width:50%">
      <div class="w3-left-align w3-padding-large">
        <p>My Complete Name is Rachmawati Ari Taurisia. You can Call me by Rachma or Ari. Mostly my friends in communities call me Rachma. Some others and my Family call me Ari</p>
        <p>My Educational Background is Diploma 3 of Informatics Management 1996-2000.
        <p>I love to learn the new things (Technology, business, writing, self devekopment)</p>
		<p>Join in communities and events</p>
      </div>
    </div>
  </div>
</div>
...
<div class="w3-row">
  <div class="w3-half w3-light-grey w3-center" style="min-height:800px" id="work">
    ...
    <div class="w3-row">
      <div class="w3-half">
	    <p>The third Winner Article Writing IWD2020</p>
        <img src="/w3images/coffee.jpg" style="width:100%">
      </div>
      <div class="w3-half">
	    <p>The Spesialization Architecting with Google Compute Engine</p>
        <img src="/w3images/workbench.jpg" style="width:100%">
      </div>
    </div>
    <div class="w3-row w3-hide-small">
      <div class="w3-half">
	    <p>The Spesialization Architecting with Google Kubernetes Engine</p>
        <img src="/w3images/workbench.jpg" style="width:100%">
      </div>
      <div class="w3-half">
	    <p>Medium.com/@aritaurisia</p>
        <img src="/w3images/coffee.jpg" style="width:100%">
      </div>
    </div>
    <div class="w3-row w3-hide-small">
...
<div class="w3-row" id="contact">
  <div class="w3-half w3-dark-grey w3-container w3-center" style="height:700px">
    ...
    <div class="w3-padding-64">
      <p>..for hiring me, or whatever.</p>
      <p>Cimahi,West Java</p>
      <p>racharta2020@gmail.com</p>
    </div>
	<div class="container-fluid bg-dark text-light">
	      <div class="row">
		    <div class="col-md-8 mx-auto">
			<ul class="list-inline text-center">
			<p>twitter</p><a href="https://twitter.com/racharta">twitter</a>			      
			<p>LinkedIn</p><a href="https://www.linkedin.com/in/rachmawati-ari-taurisia-830b6786/">LinkedIn</a> 
			<p>Instagram</p><a href="https://www.instagram.com/racharta">Instagam</a>  
			</ul>
			</div>
		  </div>	
	   </div>
